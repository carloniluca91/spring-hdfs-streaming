...
public class Bancll01Avro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4331554282280735982L;
   ...
   */
  public static it.luca.streaming.model.Bancll01Avro.Builder newBuilder() {
    return new it.luca.streaming.model.Bancll01Avro.Builder();
  }
   ...
   * @return A new Bancll01Avro RecordBuilder
   */
  public static it.luca.streaming.model.Bancll01Avro.Builder newBuilder(it.luca.streaming.model.Bancll01Avro.Builder other) {
    return new it.luca.streaming.model.Bancll01Avro.Builder(other);
  }
   ...
   * @return A new Bancll01Avro RecordBuilder
   */
  public static it.luca.streaming.model.Bancll01Avro.Builder newBuilder(it.luca.streaming.model.Bancll01Avro other) {
    return new it.luca.streaming.model.Bancll01Avro.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Bancll01Avro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(it.luca.streaming.model.Bancll01Avro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(it.luca.streaming.model.Bancll01Avro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.first_name)) {
        this.first_name = data().deepCopy(fields()[0].schema(), other.first_name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder clearFirstName() {
      first_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder clearLastName() {
      last_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder setBirthDate(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder clearBirthDate() {
      birth_date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder setInsertTs(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder clearInsertTs() {
      insert_ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder setInsertDt(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.streaming.model.Bancll01Avro.Builder clearInsertDt() {
      insert_dt = null;
